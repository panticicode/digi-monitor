...
<div class="page-content-wrapper-inner">
	...
	<div class="content-viewport">
		...
		<div class="col-lg-12">
			<div class="grid">
				<p class="grid-header">Create Info Suppliers</p>
				<div class="grid-body">
							...
							<div class="col-md-8 mx-auto">
								...
								@csrf	
									...
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-9 showcase_content_area">
											<textarea name="contact_person" id="inputType11" class="form-control {{ $errors->has('contact_person') ? 'is-invalid' : '' }}" rows="10">{{ old('contact_person') }}</textarea>
									...
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-9 showcase_content_area">
											<input type="text" name="land_line" id="inputType111" class="form-control {{ $errors->has('land_line') ? 'is-invalid' : '' }}" value="{{ old('land_line') }}">
									...
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-9 showcase_content_area">
											<input type="text" name="cell" id="inputType111" class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" value="{{ old('cell') }}">
											@if($errors->has('cell'))
												<div class="invalid-feedback">
													{{ $errors->first('cell') }}
												</div>
									...
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-9 showcase_content_area">
											<input type="text" name="physical_address" id="inputType14" class="form-control {{ $errors->has('physical_address') ? 'is-invalid' : '' }}" value="{{ old('physical_address') }}">
