...
<div class="page-content-wrapper-inner">
	...
	<div class="content-viewport">
		...
		<div class="col-lg-12">
			<div class="grid">
				<p class="grid-header">Edit Groups</p>
				<div class="grid-body">
					<div class="item-wrapper">
						<div class="row mb-3">
							<div class="col-md-12 mx-auto">
								<form class="form" action="{{ route('dashboard.groups.update', $group) }}" method="post">
									@csrf	
									@method('PUT')
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-3 showcase_content_area">
											<input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $group->name) }}">
											@if($errors->has('name'))
									...
									<div class="form-group row showcase_row_area">
										...
										<div class="col-md-3 showcase_content_area">
											<input type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" value="{{ old('description', $group->description) }}">
									...
									<div id="temp" class="row"><div class="col-sm-12">
										<table id="sample-data-table" class="data-table table table-striped dataTable" role="grid" aria-describedby="sample-data-table_info">
											<thead>
												<tr role="row">
													<th class="" rowspan="1" colspan="1" style="width: 124px;">Full Name</th>
													<th class="" rowspan="1" colspan="1" style="width: 210px;">Birthday</th>
													<th class="" rowspan="1" colspan="1" style="width: 90px;">Gender</th>
													<th class="" rowspan="1" colspan="1" style="width: 42px;">Phone</th>
										...
										<div class="form-group row showcase_text_area text-right">
											<div class="col-md-2"> 
												<button type="button" class="btn btn-success col-md-6 create">Update</button>
											</div>
										</div>
									</div>
								</form>
